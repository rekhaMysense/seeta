      ...
      <div class="card-body">
         <div class="row">
            ...
            <div class="col-md-5" style="text-align:center">
               <h1><?php echo $current_repo?'Your Linked repo - '.$current_repo:'No active repository' ?> </h1>
            </div>
            <?php  endif; ?>
         </div>
      </div>
               ...
               <div>
                  ...
                  <div>
                     <div class="div-center">
                        ...
                        <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#pushChangesModal">
                        Push changes
                        </button>
...
<div class="modal fade" id="pushChangesModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Commit Message</h5>
      ...
      <textarea class="form-control" name="commit_msg" id="commit_msg" rows="3"></textarea>
      </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary git-push-request">Commit & Push</button>
      </div>
    </div>
  </div>
</div>
